...
import { getRules } from "@eggziom/geek-regime-js-configs/dist/webpack";
import baseConfig from "@eggziom/geek-regime-js-configs/dist/webpack/config.base";
...
const sharedConfig: CallableOption = (env, argv) => {
    const coreConfig = merge(baseConfig(env, argv), {
        resolve: {
            alias: {
                "@": path.join(cwd, "src"),
            },
